...
#요인별 변수 묶기
fa1<-data.frame(data$상업, data$숙박)
fa2<-data.frame(data$업무, data$유동인구, data$문화)

fa1<-round((fa1$data.상업+fa1$data.숙박)/ncol(fa1),2)
fa2<-round((fa2$data.업무+fa2$data.문화+fa2$data.유동인구)/ncol(fa2),3)
